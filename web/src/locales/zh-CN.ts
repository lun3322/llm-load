...
addKey: "添加密钥",
    ...
    validateDeprecatedKeys: "验证弃用密钥",
    manageKeys: "管理密钥",
    lastValidationResponse: "最后一次验证返回值",
    filterByLastValidationResponse: "按最后一次验证返回值筛选",
    setToDeprecated: "设为弃用",
    batchUpdateToDeprecated: "批量设为弃用",
    confirmBatchUpdateToDeprecated: "确认将所有最后一次验证返回值为 \"{response}\" 的密钥设为弃用状态？",
