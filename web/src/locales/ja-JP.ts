export default {
  ...
  keys: {
    ...
    exportDeprecatedKeys: "非推奨キーをエクスポート",
    restoreAllInvalidKeys: "すべての無効キーを復元",
    deprecateByFilter: "一括非推奨キー",
    confirmDeprecateByFilter: "一致するキーを一括で非推奨にしてもよろしいですか？この操作は元に戻せません！",
    ...
    validateDeprecatedKeys: "非推奨キーを検証",
    ...
    responseFilterPlaceholder: "レスポンスフィルター (例: 401)",
    searchByName: "名前で検索...",
