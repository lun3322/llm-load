export default {
  ...
  keys: {
    ...
    exportDeprecatedKeys: "Export Deprecated Keys",
    restoreAllInvalidKeys: "Restore All Invalid Keys",
    deprecateByFilter: "Batch Deprecate Keys",
    confirmDeprecateByFilter:
      "Are you sure to batch deprecate matching keys? This operation cannot be undone!",
    ...
    validateDeprecatedKeys: "Validate Deprecated Keys",
    ...
    responseFilterPlaceholder: "Response filter (e.g., 401)",
