...
valid: "Valid",
    ...
    lastValidationResponse: "Last Validation Response",
    filterByLastValidationResponse: "Filter by last validation response",
    setToDeprecated: "Set to Deprecated",
    batchUpdateToDeprecated: "Batch Set to Deprecated",
    confirmBatchUpdateToDeprecated: "Confirm to set all keys with last validation response \"{response}\" to deprecated status?",
