...
func (ch *AnthropicChannel) ValidateKey(ctx context.Context, apiKey *models.APIKey, group *models.Group) (bool, int, string, error) {
	...
	if err != nil {
		return false, 0, "", fmt.Errorf("failed to parse validation endpoint: %w", err)
	}
